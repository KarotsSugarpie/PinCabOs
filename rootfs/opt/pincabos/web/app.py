...
<div class="card">
  ...
  <table>
    ...
    <tr><td>Tables VPX</td><td><code>/home/pinball/Tables</code></td></tr>
...
<div class="card" style="margin-top:20px;">
  ...
  <div class="card" style="background:rgba(95,42,145,0.18); border-color:rgba(95,42,145,0.45); margin:12px 0;">
    ...
    <p>
      ...
      <code>/home/pinball/Tables</code>. La structure n’est pas reclassée
    ...
    for archive_path in archives:
        try:
            with tempfile.TemporaryDirectory(prefix="pincabos-json-found-") as td:
                ...
                if table_folder:
                    table_root = Path("/home/pinball/Tables") / table_folder
...
def pincabos_manifest_import_conflict_page(batch_dir, archive_path, table_folder):
    ...
    i = 2
    while (Path("/home/pinball/Tables") / suggested).exists():
...
def pincabos_audio_page_alias():
    # Page minimale propre si l'ancien module Audio/SSF n'est pas présent dans ce app.py.
    return page("Audio / SSF", """
<div class="card">
  <h2>Audio / SSF</h2>
  <p>Section Audio/SSF disponible côté PinCabOS, mais le module complet n’est pas encore branché dans cette WebApp importée.</p>
  <p>Config actuelle VPX :</p>
  <pre>/home/pinball/.vpinball/VPinballX.ini</pre>
  <p>Retour conseillé : utiliser VPX/VPinFE déjà fonctionnels pendant qu’on reconnecte le module Audio propre.</p>
</div>
""")
